"""
Script directo para actualizar el ENUM timeline_type
Sin cargar toda la aplicación Flask
"""
import pymssql
import os
...
def fix_timeline_type_enum():
    """Actualiza el enum timeline_type directamente en SQL Server"""
    ...
    try:
        ...
        for constraint in constraints:
            ...
            try:
                cursor.execute(f"ALTER TABLE timelines DROP CONSTRAINT [{constraint_name}]")
        ...
        if col_info:
            ...
            if col_info[0] != 'varchar' or (col_info[1] and col_info[1] < 20):
                ...
                cursor.execute("ALTER TABLE timelines ALTER COLUMN timeline_type VARCHAR(20) NULL")
                conn.commit()
...
if __name__ == '__main__':
    print("\n" + "=" * 60)
    print("SCRIPT: Actualizar ENUM timeline_type (Directo)")
    print("=" * 60)
